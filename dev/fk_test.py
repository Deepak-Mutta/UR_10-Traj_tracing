...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    ee_marker = VisualizationMarkers(frame_marker_cfg.replace(prim_path="/Visuals/ee_frame"))
    ...
    count = 0
    angles = torch.Tensor([15.11021204,-122.22670756,  149.62801035,  -90.80873088, -104.43969992,  -26.46506603])
